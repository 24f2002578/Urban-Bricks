  ...
  return (
    <style>{`
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      /* WhatsApp FAB Responsive Styling */
      .whatsapp-fab-btn {
        position: fixed;
        bottom: 24px;
        right: 24px;
    ...
    <footer ref={footerRef} style={{ position: "relative", overflow: "hidden", transition: "background 0.5s" }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .footer-grid .footer-links-col {
            justify-self: start !important;
            align-items: flex-start !important;
            text-align: left !important;
            width: 100% !important;
          }
          .footer-grid .footer-links-col h4 span {
            left: 0 !important;
            right: auto !important;
            transform: none !important;
          }
          .footer-grid .footer-links-col .footer-link-item {
            justify-content: flex-start !important;
          }
          .footer-grid .footer-links-col .contact-item {
            justify-content: flex-start !important;
            align-items: flex-start !important;
            text-align: left !important;
          }
          .footer-grid .footer-links-col .business-hours {
            text-align: left !important;
          }
        }
      `}</style>
